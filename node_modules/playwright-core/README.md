...
i. Programming Language: JavaScript (Node.js)	
ii. Framework: Playwright
iii. Required Node.js Version: 18 or higher
iv. Browser Driver: Playwright browsers (installed using npx playwright install)

•	Project Files:
i. automation.js – Main automation script
ii. temp-mail.js – Generates a temporary email address and retrieves the OTP for email verification
iii. package.json – Contains the project metadata and dependencies
